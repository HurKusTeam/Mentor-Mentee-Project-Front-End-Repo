        ...
        <v-row>
          <v-col sm="3" md="3" class="pl-1"
            ><AdvertDetailCompany
              ...
              :image="this.advert.Userprof?.ProfileImage" />
  ...
  methods: {
    async createUser() {
      return await this.$axios
        .$get('/api/GetAdvertSolo/' + this.mentorid)
        .then((response) => {
