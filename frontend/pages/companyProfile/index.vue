<template>
  <v-main>
    <CompanyProfileHeader :title="this.users.Title" :sector="this.users.Sector"
      :personalCount="this.users.PersonalCount" :sinceDate="this.users.SinceDate" :mail="this.users.Mail"
      ...
      :website="this.users.Website" :description="this.users.Description" :profilePhoto="this.users.ProfileImage"
      @loading="getLoading" />
